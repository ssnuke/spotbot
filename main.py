...
def main() -> None:
    ...
    if args.mode == "backtest":
        ...
        backtest_config = BacktestConfig(
            ...
            min_entry_spacing_ticks=config.backtest.min_entry_spacing_ticks,
            drawdown_recovery_period=config.backtest.drawdown_recovery_period,
            compounding_enabled=config.backtest.compounding_enabled,
    ...
    try:
        runner = LiveRunner(
            ...
            risk_config=RiskConfig(
                ...
                drawdown_recovery_period=config.risk.drawdown_recovery_period,
