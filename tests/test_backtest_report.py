...
def test_backtest_report_contains_key_metrics():
    ...
    result = backtester.run([
        ...
        [0, 101.0, 101.0, 101.0, 101.0, 101.0],
        [0, 102.0, 102.0, 102.0, 102.0, 102.0],
        [0, 103.0, 103.0, 103.0, 103.0, 103.0],
        [0, 104.0, 104.0, 104.0, 104.0, 104.0],
        [0, 105.0, 105.0, 105.0, 105.0, 105.0],
        [0, 106.0, 106.0, 106.0, 106.0, 106.0],
        [0, 107.0, 107.0, 107.0, 107.0, 107.0],
        [0, 108.0, 108.0, 108.0, 108.0, 108.0],
        [0, 109.0, 109.0, 109.0, 109.0, 109.0],
        [0, 110.0, 110.0, 110.0, 110.0, 110.0],
    ])
